...
Updated routine: Effective from 25 March 2026
...
# Updated to match new routine image
COURSE_META = {
    # BBA 2nd Year 1st Semester (Session: 2023-24)
    'MGT-2101': ('BBA', 2, 1), 'GED-2102': ('BBA', 2, 1),
    'GED-2103': ('BBA', 2, 1), 'GED-2104': ('BBA', 2, 1),
    'MGT-2105': ('BBA', 2, 1),
    # BBA 3rd Year 1st Semester (Session: 2022-23)
    'MGT-3101': ('BBA', 3, 1), 'MGT-3102': ('BBA', 3, 1),
    'MGT-3103': ('BBA', 3, 1), 'MGT-3104': ('BBA', 3, 1),
    'MGT-3105': ('BBA', 3, 1),
    # BBA 3rd Year 2nd Semester (Session: 2021-22)
    'MGT-3201': ('BBA', 3, 2), 'MGT-3202': ('BBA', 3, 2),
    'MGT-3203': ('BBA', 3, 2), 'MGT-3204': ('BBA', 3, 2),
    'MGT-3205': ('BBA', 3, 2), 'GED-3203': ('BBA', 3, 2),
    # MBA 2nd Semester (Session: 2023-24)
    'HRM-5201': ('MBA', 2, 1), 'HRM-5202': ('MBA', 2, 1),
    'HRM-5203': ('MBA', 2, 1), 'HRM-5204': ('MBA', 2, 1),
    'HRM-5205': ('MBA', 2, 1),
    # MBA 1st Semester (Session: 2024-25)
    'HRM-5101': ('MBA', 1, 1), 'HRM-5102': ('MBA', 1, 1),
    'HRM-5103': ('MBA', 1, 1), 'HRM-5104': ('MBA', 1, 1),
    'HRM-5105': ('MBA', 1, 1),
}
...
def get_seed_routines() -> List[Dict]:
    ...
    Routine image data (Row format):
    Day, Room, TimeSlot, TimeStart, TimeEnd, CourseCode, TeacherCode
    """
    raw = [
        # ── SUNDAY ──────────────────────────────────────────────────────
        # Room 101
    ...
    for r in raw:
        ...
        result.append({
            "day": r[0], "room_no": r[1],
            "time_slot": r[2], "time_start": r[3], "time_end": r[4],
            "course_code": cc, "teacher_code": r[6],
            "program": meta[0], "course_year": meta[1],
            "course_semester": meta[2], "session": "2025-26",
        })
    return result
